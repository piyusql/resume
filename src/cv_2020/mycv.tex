...
\workposition{Since April 2021} % Duration
{} % FT/PT (full time or part time)
{F5 Networks (Volterra)} % Employer
{Senior Software Engineer} % Job title
    {I am part of frontend team at Volterra F5.} % Description

%------------------------------------------------

\workposition{Sep 2015 -- March 2021} % Duration
{} % FT/PT (full time or part time)
...
{In this particular job at seed startup, I learned most of the experimental methods, failing fast and build fast, improvement ideas and being passionate towards work. To work in an enviroment where deadline was important even without compromising quality.} % Description
